...
- **Star**: 16,801 · **Fork**: 1,399 · **开放 issue**: 2,888 · **贡献者**: 165
...
在 [repology.org](https://repology.org/project/weaviate) 上共有 **10** 个发行版报告此项目。**1** 个 ✅ 已是最新上游版本，**9** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260912.yml` · 2026-09-12T05:27:53Z._
