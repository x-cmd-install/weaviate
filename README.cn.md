...
- **Star**: 16,802 · **Fork**: 1,399 · **开放 issue**: 2,888 · **贡献者**: 165

## 累计统计

- **发布数**: 580 · **已合并 PR**: 7905 · **开放 PR**: 277 · **已关闭 issue**: 2420 · **开放 issue**: 468 · **提交数**: 29551
...
在 [repology.org](https://repology.org/project/weaviate) 上共有 **10** 个发行版报告此项目。**3** 个 ✅ 已是最新上游版本，**7** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260913.yml` · 2026-09-13T05:40:31Z._
